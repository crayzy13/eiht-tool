...
class CommitInfo(Screen):
    ...
    def __init__(self, session):
        ...
        self['key_red'] = Button(_('Cancel'))
        self.project = 0
        self.projects = [('https://api.github.com/repos/Openeight/enigma2/commits', 'enigma2'), ('https://api.github.com/repos/Openeight/OctagonEightSD/commits', 'OctagonEightSD'), ('https://api.github.com/repos/Openeight/OctagonEightFHD/commits', 'OctagonEightFHD')]
        self.cachedProjects = {}
        self.Timer = eTimer()
